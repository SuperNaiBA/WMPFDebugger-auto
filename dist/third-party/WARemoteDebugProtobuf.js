...
$root.mmbizwxadevremote = (function () {
    ...
    mmbizwxadevremote.WARemoteDebug_DataFormat = (function () {
        ...
        WARemoteDebug_DataFormat.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_DataFormat();
    ...
    mmbizwxadevremote.WARemoteDebug_BaseReq = (function () {
        ...
        WARemoteDebug_BaseReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_BaseReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_BaseResp = (function () {
        ...
        WARemoteDebug_BaseResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_BaseResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_CommReq = (function () {
        ...
        WARemoteDebug_CommReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_CommReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_CommResp = (function () {
        ...
        WARemoteDebug_CommResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_CommResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_DebugMessage = (function () {
        ...
        WARemoteDebug_DebugMessage.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_DebugMessage();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_SendDebugMessageReq = (function () {
        ...
        WARemoteDebug_SendDebugMessageReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_SendDebugMessageReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_SendDebugMessageResp = (function () {
        ...
        WARemoteDebug_SendDebugMessageResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_SendDebugMessageResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_NewSendDebugMessageReq = (function () {
        ...
        WARemoteDebug_NewSendDebugMessageReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_NewSendDebugMessageReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_NewSendDebugMessageResp = (function () {
        ...
        WARemoteDebug_NewSendDebugMessageResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_NewSendDebugMessageResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_MessageNotify = (function () {
        ...
        WARemoteDebug_MessageNotify.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_MessageNotify();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_MessageNotifyResp = (function () {
        ...
        WARemoteDebug_MessageNotifyResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_MessageNotifyResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_EventNotify = (function () {
        ...
        WARemoteDebug_EventNotify.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_EventNotify();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    default:
    ...
    mmbizwxadevremote.WARemoteDebug_EventNotifyResp = (function () {
        ...
        WARemoteDebug_EventNotifyResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_EventNotifyResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    default:
    ...
    mmbizwxadevremote.WARemoteDebug_WxHeartBeatReq = (function () {
        ...
        WARemoteDebug_WxHeartBeatReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_WxHeartBeatReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_WxHeartBeatResp = (function () {
        ...
        WARemoteDebug_WxHeartBeatResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_WxHeartBeatResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_DevHeartBeatReq = (function () {
        ...
        WARemoteDebug_DevHeartBeatReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_DevHeartBeatReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_DevHeartBeatResp = (function () {
        ...
        WARemoteDebug_DevHeartBeatResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_DevHeartBeatResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_RoomInfo = (function () {
        ...
        WARemoteDebug_RoomInfo.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_RoomInfo();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_WxLoginReq = (function () {
        ...
        WARemoteDebug_WxLoginReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_WxLoginReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_WxLoginResp = (function () {
        ...
        WARemoteDebug_WxLoginResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_WxLoginResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_DevLoginReq = (function () {
        ...
        WARemoteDebug_DevLoginReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_DevLoginReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_DevLoginResp = (function () {
        ...
        WARemoteDebug_DevLoginResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_DevLoginResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_WxJoinRoomReq = (function () {
        ...
        WARemoteDebug_WxJoinRoomReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_WxJoinRoomReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_WxJoinRoomResp = (function () {
        ...
        WARemoteDebug_WxJoinRoomResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_WxJoinRoomResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_DevJoinRoomReq = (function () {
        ...
        WARemoteDebug_DevJoinRoomReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_DevJoinRoomReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_DevJoinRoomResp = (function () {
        ...
        WARemoteDebug_DevJoinRoomResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_DevJoinRoomResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_WxQuitRoomReq = (function () {
        ...
        WARemoteDebug_WxQuitRoomReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_WxQuitRoomReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_WxQuitRoomResp = (function () {
        ...
        WARemoteDebug_WxQuitRoomResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_WxQuitRoomResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_DevQuitRoomReq = (function () {
        ...
        WARemoteDebug_DevQuitRoomReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_DevQuitRoomReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_DevQuitRoomResp = (function () {
        ...
        WARemoteDebug_DevQuitRoomResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_DevQuitRoomResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_WxSyncMessageReq = (function () {
        ...
        WARemoteDebug_WxSyncMessageReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_WxSyncMessageReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_WxSyncMessageResp = (function () {
        ...
        WARemoteDebug_WxSyncMessageResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_WxSyncMessageResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_DevSyncMessageReq = (function () {
        ...
        WARemoteDebug_DevSyncMessageReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_DevSyncMessageReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_DevSyncMessageResp = (function () {
        ...
        WARemoteDebug_DevSyncMessageResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_DevSyncMessageResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_MethodWithArgs = (function () {
        ...
        WARemoteDebug_MethodWithArgs.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_MethodWithArgs();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_RegisterInterface = (function () {
        ...
        WARemoteDebug_RegisterInterface.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_RegisterInterface();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_DeviceInfo = (function () {
        ...
        WARemoteDebug_DeviceInfo.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_DeviceInfo();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_SetupContext = (function () {
        ...
        WARemoteDebug_SetupContext.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_SetupContext();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_CallInterface = (function () {
        ...
        WARemoteDebug_CallInterface.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_CallInterface();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_CallInterfaceResult = (function () {
        ...
        WARemoteDebug_CallInterfaceResult.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_CallInterfaceResult();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_EvaluateJavascript = (function () {
        ...
        WARemoteDebug_EvaluateJavascript.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_EvaluateJavascript();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_EvaluateJavascriptResult = (function () {
        ...
        WARemoteDebug_EvaluateJavascriptResult.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_EvaluateJavascriptResult();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_Breakpoint = (function () {
        ...
        WARemoteDebug_Breakpoint.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_Breakpoint();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_Ping = (function () {
        ...
        WARemoteDebug_Ping.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_Ping();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_Pong = (function () {
        ...
        WARemoteDebug_Pong.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_Pong();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_DomOp = (function () {
        ...
        WARemoteDebug_DomOp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_DomOp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_DomEvent = (function () {
        ...
        WARemoteDebug_DomEvent.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_DomEvent();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_NetworkDebugAPI = (function () {
        ...
        WARemoteDebug_NetworkDebugAPI.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_NetworkDebugAPI();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_ChromeDevtools = (function () {
        ...
        WARemoteDebug_ChromeDevtools.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_ChromeDevtools();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_ChromeDevtoolsResult = (function () {
        ...
        WARemoteDebug_ChromeDevtoolsResult.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_ChromeDevtoolsResult();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_AddJsContext = (function () {
        ...
        WARemoteDebug_AddJsContext.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_AddJsContext();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_RemoveJsContext = (function () {
        ...
        WARemoteDebug_RemoveJsContext.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_RemoveJsContext();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_ConnectJsContext = (function () {
        ...
        WARemoteDebug_ConnectJsContext.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_ConnectJsContext();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
    ...
    mmbizwxadevremote.WARemoteDebug_CustomMessage = (function () {
        ...
        WARemoteDebug_CustomMessage.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.mmbizwxadevremote.WARemoteDebug_CustomMessage();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
