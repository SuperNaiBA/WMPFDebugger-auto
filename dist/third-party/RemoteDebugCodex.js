...
!function (require, directRequire) {
    ...
    const e = require("zlib"), o = require('./WARemoteDebugProtobuf.js'), t = require('./RemoteDebugConstants.js'), s = require('./RemoteDebugUtils.js'), a = { e: (msg) => { console.error(msg); } };
    let n;
    function r(e) {
    ...
    function c(s) {
        ...
        if (i)
            switch (s.category) {
                ...
                case t.DebugMessageCategory.CallInterface: {
                    const e = o.mmbizwxadevremote.WARemoteDebug_CallInterface.decode(i), t = o.mmbizwxadevremote.WARemoteDebug_CallInterface.toObject(e);
                    b = {
                        name: t.objName,
                        method: t.methodName,
                ...
                case t.DebugMessageCategory.CallInterfaceResult: {
                    const e = o.mmbizwxadevremote.WARemoteDebug_CallInterfaceResult.decode(i), t = o.mmbizwxadevremote.WARemoteDebug_CallInterfaceResult.toObject(e);
                    b = {
                        ret: t.ret,
                        call_id: t.callId,
                ...
                case t.DebugMessageCategory.EvaluateJavascript: {
                    const e = o.mmbizwxadevremote.WARemoteDebug_EvaluateJavascript.decode(i), t = o.mmbizwxadevremote.WARemoteDebug_EvaluateJavascript.toObject(e);
                    b = {
                        script: t.script,
                ...
                case t.DebugMessageCategory.EvaluateJavascriptResult: {
                    const e = o.mmbizwxadevremote.WARemoteDebug_EvaluateJavascriptResult.decode(i), t = o.mmbizwxadevremote.WARemoteDebug_EvaluateJavascriptResult.toObject(e);
                    b = {
                        ret: t.ret,
                        evaluate_id: t.evaluateId
                    };
                ...
                case t.DebugMessageCategory.Ping: {
                    const e = o.mmbizwxadevremote.WARemoteDebug_Ping.decode(i), t = o.mmbizwxadevremote.WARemoteDebug_Ping.toObject(e);
                    b = {
                        ping_id: t.pingId,
                        payload: t.payload
                    };
                ...
                case t.DebugMessageCategory.Pong: {
                    const e = o.mmbizwxadevremote.WARemoteDebug_Pong.decode(i), t = o.mmbizwxadevremote.WARemoteDebug_Pong.toObject(e, {
                        longs: Number
                    });
                    b = {
                        ping_id: t.pingId,
                ...
                case t.DebugMessageCategory.SetupContext: {
                    const e = o.mmbizwxadevremote.WARemoteDebug_SetupContext.decode(i), t = o.mmbizwxadevremote.WARemoteDebug_SetupContext.toObject(e);
                    b = {
                        register_interface: {
                ...
                case t.DebugMessageCategory.DomOp: {
                    const e = o.mmbizwxadevremote.WARemoteDebug_DomOp.decode(i), t = o.mmbizwxadevremote.WARemoteDebug_DomOp.toObject(e);
                    b = {
                        params: t.params,
                ...
                case t.DebugMessageCategory.DomEvent: {
                    const e = o.mmbizwxadevremote.WARemoteDebug_DomEvent.decode(i), t = o.mmbizwxadevremote.WARemoteDebug_DomEvent.toObject(e);
                    b = {
                        params: t.params,
                        webview_id: t.webviewId
                    };
                ...
                case t.DebugMessageCategory.NetworkDebugAPI: {
                    const e = o.mmbizwxadevremote.WARemoteDebug_NetworkDebugAPI.decode(i), t = o.mmbizwxadevremote.WARemoteDebug_NetworkDebugAPI.toObject(e);
                    b = {
                        api_name: t.apiName,
                        task_id: t.taskId,
                ...
                case t.DebugMessageCategory.ChromeDevtools: {
                    const e = o.mmbizwxadevremote.WARemoteDebug_ChromeDevtools.decode(i), t = o.mmbizwxadevremote.WARemoteDebug_ChromeDevtools.toObject(e);
                    b = {
                        op_id: t.opId,
                        payload: t.payload,
                ...
                case t.DebugMessageCategory.ChromeDevtoolsResult: {
                    const e = o.mmbizwxadevremote.WARemoteDebug_ChromeDevtoolsResult.decode(i), t = o.mmbizwxadevremote.WARemoteDebug_ChromeDevtoolsResult.toObject(e);
                    b = {
                        op_id: t.opId,
                        payload: t.payload,
                        jscontext_id: t.jscontextId
                ...
                case t.DebugMessageCategory.AddJsContext: {
                    const e = o.mmbizwxadevremote.WARemoteDebug_AddJsContext.decode(i), t = o.mmbizwxadevremote.WARemoteDebug_AddJsContext.toObject(e);
                    b = {
                        jscontext_id: t.jscontextId,
                ...
                case t.DebugMessageCategory.CustomMessage: {
                    const e = o.mmbizwxadevremote.WARemoteDebug_CustomMessage.decode(i), t = o.mmbizwxadevremote.WARemoteDebug_CustomMessage.toObject(e);
                    b = {
                        method: t.method,
                        payload: t.payload,
                        raw: t.raw
    ...
    function g(e) {
        if (!e)
            throw new Error("invalid buffer " + e);
        if ("Uint8Array" === e.constructor.name || e.constructor === Uint8Array)
            return e;
    ...
    exports.requestCmdForType = i, exports.clientRequestCmdForType = m, exports.wrapDebugMessageData = b, exports.wrapOutgoingToProto = function (e, n, r, m = !1) {
        ...
        const s = o.mmbizwxadevremote.WARemoteDebug_DataFormat.decode(e), n = "string" == typeof s.data ? Buffer.from(s.data) : s.data;
        let i = null;
        switch (s.cmd) {
            ...
            case t.ResponseType.Login: {
                const e = o.mmbizwxadevremote.WARemoteDebug_DevLoginResp.decode(n), t = o.mmbizwxadevremote.WARemoteDebug_DevLoginResp.toObject(e);
                i = {
            ...
            case t.ResponseType.EventNotifyBegin: {
                const e = o.mmbizwxadevremote.WARemoteDebug_EventNotify.decode(n), t = o.mmbizwxadevremote.WARemoteDebug_EventNotify.toObject(e);
                i = {
            ...
            case t.ResponseType.MessageNotify: {
                const e = o.mmbizwxadevremote.WARemoteDebug_MessageNotify.decode(n).debugMessageList, t = [];
                for (const o of e)
                    t.push(c(o));
                i = {
                    debug_message: t
            ...
            case t.ResponseType.SendDebugMessageParallelly: {
                const e = o.mmbizwxadevremote.WARemoteDebug_NewSendDebugMessageResp.decode(n), t = o.mmbizwxadevremote.WARemoteDebug_NewSendDebugMessageResp.toObject(e);
                i = {
                    base_response: t.baseResponse,
                    max_ack: t.maxAck,
                    min_ack: t.minAck
            ...
            case t.ResponseType.SendDebugMessage: {
                const e = o.mmbizwxadevremote.WARemoteDebug_SendDebugMessageResp.decode(n), t = o.mmbizwxadevremote.WARemoteDebug_SendDebugMessageResp.toObject(e);
                i = {
                    base_response: t.baseResponse,
                    send_ack: t.sendAck
                };
            ...
            case t.ResponseType.SyncMessage: {
                const e = o.mmbizwxadevremote.WARemoteDebug_DevSyncMessageResp.decode(n), t = e.debugMessageList, s = [];
                for (const e of t)
                    s.push(c(e));
                i = {
                    debug_message: s,
        ...
        switch (s.cmd) {
            case t.ClientRequestCmd.Login: {
                const e = o.mmbizwxadevremote.WARemoteDebug_WxLoginReq.decode(n), t = o.mmbizwxadevremote.WARemoteDebug_WxLoginReq.toObject(e);
                i = {
                    base_request: {
            ...
            case t.ClientRequestCmd.Heartbeat: {
                const e = o.mmbizwxadevremote.WARemoteDebug_WxHeartBeatReq.decode(n), t = o.mmbizwxadevremote.WARemoteDebug_WxHeartBeatReq.toObject(e);
                i = {
                    base_request: {
                        clientversion: t.baseRequest
                    },
            ...
            case t.ClientRequestCmd.JoinRoom: {
                const e = o.mmbizwxadevremote.WARemoteDebug_WxJoinRoomReq.decode(n), t = o.mmbizwxadevremote.WARemoteDebug_WxJoinRoomReq.toObject(e);
                i = {
                    base_request: {
                        clientversion: t.baseRequest
                    },
            ...
            case t.ClientRequestCmd.SendDebugMessageParallelly: {
                const e = o.mmbizwxadevremote.WARemoteDebug_NewSendDebugMessageReq.decode(n), t = o.mmbizwxadevremote.WARemoteDebug_NewSendDebugMessageReq.toObject(e);
                i = {
                    base_request: {
                        clientversion: t.baseRequest
                    },
            ...
            case t.ClientRequestCmd.SyncMessage: {
                const e = o.mmbizwxadevremote.WARemoteDebug_WxSyncMessageReq.decode(n), t = o.mmbizwxadevremote.WARemoteDebug_WxSyncMessageReq.toObject(e);
                i = {
                    base_request: {
                        clientversion: t.baseRequest
                    },
        ...
        switch (n) {
            ...
            case t.ClientResponseType.EventNotifyBlock:
            case t.ClientResponseType.EventNotifyBegin: {
                const e = {}, t = o.mmbizwxadevremote.WARemoteDebug_EventNotify.verify(e);
                (0, s.expect)(Boolean(t), a).toBe(!1).fail(() => {
